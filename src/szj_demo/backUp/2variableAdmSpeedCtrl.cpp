...
const double linear_mass=100;
const double linear_damp=5000;
...
public:
    variableAdmCtrl()
    {
        ...
        while (ros::ok())
        {
            ...
            double zdd = (1/linear_mass)*(fzErr - linear_damp*(vel_now-0) - linear_damp*phi);
            ...
            if(0){
                ...
                if(directionFlag<480) command_vel[1]=1;
                else if(directionFlag<500) command_vel[1]=0;
                else if(directionFlag<980) command_vel[1]=-1;
            ...
            pubData_admStatus.paraB = linear_damp+linear_damp*phi;
