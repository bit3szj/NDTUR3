    ...
    class Cartesian_Velocity_Position_Controller: public kdl_base::KDL_Base {
        public:
            ...
            */
            ...
            void command_cart_pos_correct(const geometry_msgs::PoseConstPtr &msg);
        private:
        ...
        protected:
            ...
            ros::Subscriber                 sub_command_correct; // Interface to external commands
            ros::Publisher                  pub_endVel;
            ros::Publisher                  pub_urScript;
            ...
            //two pose heard from two topic
            KDL::Frame                      End_Pos_sub1;
            KDL::Frame                      End_Pos_sub2;
