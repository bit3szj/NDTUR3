...
if("TRUE" STREQUAL "TRUE")
  set(cartesian_state_msgs_SOURCE_PREFIX /home/szj/myTask/test_link_UR/src/msg/cartesian_state_msgs)
  set(cartesian_state_msgs_DEVEL_PREFIX /home/szj/myTask/test_link_UR/devel)
  ...
  set(cartesian_state_msgs_INSTALL_PREFIX /home/szj/myTask/test_link_UR/install)
...
if(NOT "/home/szj/myTask/test_link_UR/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zhu zhe <zhuzhe0815@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cartesian_state_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/szj/myTask/test_link_UR/src/msg/cartesian_state_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(cartesian_state_msgs_EXPORTED_TARGETS ${${cartesian_state_msgs_dep}_EXPORTED_TARGETS})
endforeach()
