# Install script for directory: /home/szj/myTask/test_link_UR/src/admittance_controller
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/admittance_controller/srv" TYPE FILE FILES "/home/szj/myTask/test_link_UR/src/admittance_controller/srv/parameter_srv.srv")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/admittance_controller/cmake" TYPE FILE FILES "/home/szj/myTask/test_link_UR/build/admittance_controller/catkin_generated/installspace/admittance_controller-msg-paths.cmake")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/szj/myTask/test_link_UR/build/admittance_controller/catkin_generated/installspace/admittance_controller.pc")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/admittance_controller/cmake" TYPE FILE FILES "/home/szj/myTask/test_link_UR/build/admittance_controller/catkin_generated/installspace/admittance_controller-msg-extras.cmake")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/admittance_controller/cmake" TYPE FILE FILES
    "/home/szj/myTask/test_link_UR/build/admittance_controller/catkin_generated/installspace/admittance_controllerConfig.cmake"
    "/home/szj/myTask/test_link_UR/build/admittance_controller/catkin_generated/installspace/admittance_controllerConfig-version.cmake"
    )
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/admittance_controller" TYPE FILE FILES "/home/szj/myTask/test_link_UR/src/admittance_controller/package.xml")
endif()
